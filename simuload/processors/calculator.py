...
class Calculator: 
    ...
    def transformador_consumo(self, transformador_id: int):
        consumo = np.zeros((24))
        transformador = Service().consultar_transformador_pela_id(transformador_id)
        # for equip in equipamentos:
        #     equip_id = equip[0]
        #     equip_qtd = equip[2]
        #     equip_info = Service().consultar_equipamento_id(equip_id,
    ...
    def interpolador(self, consumo_curva, consumo_transf, intervalo = 1):
        ...
        consumo_transf_interp = np.interp(intervalo_interp, intervalo_horas, consumo_transf)
        
        return intervalo_interp, consumo_curva_interp/1000, consumo_transf_interp/1000

    @classmethod
    def simulate(cls, curva_id, transformador_id, curva_config):
