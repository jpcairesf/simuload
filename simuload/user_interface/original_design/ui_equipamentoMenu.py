...
class Ui_MenuEquipamento(object):
    def setupUi(self, MenuEquipamento):
        ...
        MenuEquipamento.resize(600, 500)
        ...
        self.procuraEquip.setFont(font)
        ...
        font.setFamily("Reem Kufi")
        font.setPointSize(10)
        self.equipamentoLista.setFont(font)
        ...
        font.setFamily("Reem Kufi")
        font.setPointSize(12)
        self.ExcluirEquipamento.setFont(font)
        ...
        font.setFamily("Reem Kufi")
        font.setPointSize(12)
        self.NovoEquipamento.setFont(font)
        ...
        font.setFamily("Reem Kufi")
        font.setPointSize(12)
        self.EditarEquipamento.setFont(font)
