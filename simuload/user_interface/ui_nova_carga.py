...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(130, 270, 261, 25))
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox.setTitle(_translate("Form", "Carga"))
        self.label_5.setText(_translate("Form", "Conjunto de equipamentos que constituem um consumidor"))
        self.groupBox_2.setTitle(_translate("Form", "Adicionar Equipamentos"))
        self.pushButton.setText(_translate("Form", ">"))
        self.pushButton_2.setText(_translate("Form", ">>"))
        self.pushButton_3.setText(_translate("Form", "Remover"))
        self.criarEquipamento.setText(_translate("Form", "OK"))
        self.cancelarEquipamento.setText(_translate("Form", "Cancelar"))
